    ...
    <section className="mt-12 pt-10 border-t border-[var(--border)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] gap-8 items-start">
        ...
        <div>
          ...
          >
            {generating
              ? `Painting… ${Math.round(progressMs / 1000)}s`
              : url
                ? "Regenerate cover"
                : "Generate cover"}
          </button>
          ...
          {url && !generating && (
            <a
              ...
              className="ml-3 text-sm text-[var(--accent)] hover:underline underline-offset-4"
            >
              Download
            </a>
          )}
          ...
          <p className="text-xs text-[var(--muted)] mt-4 max-w-md leading-relaxed">
            Same brief every time: two abstract figures in dark space with one
            warm light between them. Hit regenerate to roll a new variation
            until something lands. Each generation takes 20&ndash;40 seconds.
          </p>
